...
def on_put(message):
    ...
    cursor = conn.cursor()
    if message[0] == "Courses":
        cursor.execute('''INSERT INTO Courses("Course name", "Type", "Number of students") VALUES ({}, {}, {})'''.format(message[1], message[2], message[3]))
    if message[0] == "Clients":
        cursor.execute('''INSERT INTO Clients("Full Name", "Gender", "Phone number", "Email") VALUES ({}, {}, {}, {})'''.format(message[1], message[2], message[3], message[4]))
